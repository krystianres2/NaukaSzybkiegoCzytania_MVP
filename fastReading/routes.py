...
from flask import render_template, redirect, url_for, request, jsonify, flash # type: ignore
from fastReading.models import User, WpmResult, TextQuiz, QuizResult, ReadedTexts, ExerciseResult
...
@login_required
def get_ex1_text():
    text_quiz = TextQuiz.query.order_by(func.random()).first()
